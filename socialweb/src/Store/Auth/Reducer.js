...
export const authReducer=(state=initialState, action)=>{
    switch (action.type) {
        ...
        case REGISTER_USER_SUCCESS:
            return {...state,loading:false,error:null,jwt:action.payload,user:action.payload.user}
        ...
        case UPDATE_USER_SUCCESS:
            return {...state, loading:false, error:null, user: action.payload, findUser:true}
